...
public class DatabaseInterview : MonoBehaviour
{
    ...
    public QuestInterview CurQuest { get; set; }
    ...
    {
        // Объявление
        AllListQuestions = new List<ListQuestionsInterview>();
        AllQuests = new List<QuestInterview>();
        IsQuestCamOn = true;
        IsNewGame = false;
        IsInterview = false;
    ...
    {
        // Квест фермера
        AllQuests.Add(new QuestInterview(
            AllQuests.Count,
