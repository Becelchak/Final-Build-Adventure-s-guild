...
public class QuestInterview
{
    ...
    public QuestInterview(int Id, string nameQuest, string characterName, string description, int id_ListQuestions)
    {
        ID_quest = Id;
        NameQuest = nameQuest;
    ...
    public QuestInterview(int Id, string nameQuest, string characterName, string description, string highlitedWords, int id_ListQuestions)
    {
        ID_quest = Id;
        NameQuest = nameQuest;
        CharacterName = characterName;
